function UserProfile() {
  return (
    <div className="user-profile bg-gray-100 p-8 max-w-sm mx-auto my-20 rounded-lg shadow-lg md:p-8 sm:p-4 sm:max-w-xs md:max-w-sm  hover:shadow-xl">
      <img  className="w-36 h-36 rounded-full mx-auto sm:w-24 sm:h-24 md:sm:w-24 md:w-36 md:h-36 hover:scale-110 transition-transform duration-300 ease-in-out " src="src/components/flower.jpg" alt="User" />
